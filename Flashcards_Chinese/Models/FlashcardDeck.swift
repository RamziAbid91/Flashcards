...
class FlashcardDeck: ObservableObject {
    ...
    static func defaultCards() -> [Flashcard] {
        return [
            ...
            Flashcard(chinese: "忙得不可开交", pinyin: "máng de bù kě kāi jiāo", english: "Very busy", french: "Avoir de la broue dans le toupet", pronunciation: "mahng-duh-boo-kuh-kai-jyao", category: "Quebecois", difficulty: 2, exampleSentence: "最近我忙得不可开交。", examplePinyin: "Zuìjìn wǒ máng de bù kě kāi jiāo.", exampleTranslation: "I've been swamped lately. / J'ai de la broue dans le toupet ces temps-ci."),
            ...
            Flashcard(chinese: "天啊", pinyin: "tiān a", english: "Damn it!/Christ!", french: "Crisse", pronunciation: "tee-an ah", category: "Quebecois", difficulty: 3, exampleSentence: "天啊，这个太贵了！", examplePinyin: "Tiān a, zhège tài guì le!", exampleTranslation: "Damn it, this is too expensive! / Crisse, c'est trop cher !"),
            Flashcard(chinese: "见鬼", pinyin: "jiàn guǐ", english: "Damn it!/Host!", french: "Osti", pronunciation: "jee-an gway", category: "Quebecois", difficulty: 3, exampleSentence: "见鬼，我头疼！", examplePinyin: "Jiàn guǐ, wǒ tóuténg!", exampleTranslation: "Damn it, I have a headache! / Osti, j'ai mal à la tête !"),
            Flashcard(chinese: "混蛋", pinyin: "hún dàn", english: "Asshole/Bastard", french: "Ostie de cave", pronunciation: "hoon-dan", category: "Quebecois", difficulty: 3, exampleSentence: "这个混蛋！", examplePinyin: "Zhège hún dàn!", exampleTranslation: "What an asshole! / Quel ostie de cave !"),
            ...
            Flashcard(chinese: "很酷", pinyin: "hěn kù", english: "It's hot/That's cool", french: "C'est hot", pronunciation: "hen-koo", category: "Quebecois", difficulty: 2, exampleSentence: "这辆车很酷！", examplePinyin: "Zhè liàng chē hěn kù!", exampleTranslation: "This car is hot! / Ce char-là est hot !"),
